...
BOOL ini_get_option(TCHAR *err_str)
{
	...
	option.history_max_image_memory_mb = profile_get_int(TEXT("history"), TEXT("MaxImageMemoryMB"), HISTORY_IMAGE_SIZE_DEFAULT_MB, ini_path);
	if (option.history_max_image_memory_mb < 0) {
		option.history_max_image_memory_mb = HISTORY_IMAGE_SIZE_DEFAULT_MB;
	}
...
BOOL ini_put_option(void)
{
	...
	profile_write_int(TEXT("history"), TEXT("MaxImageMemoryMB"), option.history_max_image_memory_mb, ini_path);
